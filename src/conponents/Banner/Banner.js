    ...
    return (
        <section className='md:grid grid-cols-2 container mx-auto'>
            <div className='flex flex-col justify-center px-5 py-20 md:py-5'>
                ...
                <p className='mt-2'>Are you looking for happy smile teeth dental care services? Yes are in wright place. I providing dental services for your's and your family member. Please check my services and contact if any query. </p>
                <div>
